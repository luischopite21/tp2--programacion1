...
/** \brief inicializa un vector del tipo eEmployee
 *
 ...
 * \return un 1 si pudo dar el alta con exito y un 0 si la operacion no se culmino de manera exitosa
 *
 */
 ...
 *
 * \param vecot donde busca los empleados
 * \param tamaño del vector
...
/** \brief entra en la parte de informar y muestra las opciones que te da el menuInformes()
 *
